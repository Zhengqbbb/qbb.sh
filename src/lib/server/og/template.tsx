        ...
        >
            <div tw="flex absolute h-auto w-full">
                <div tw="flex flex-col absolute left--2rem top-0 h-auto w-1/2">
                    ...
                    <div tw="flex relative h-[30px] w-full flex h-[60px]">
                        <div tw="w-66px h-66px" style={{ backgroundColor: 'hsl(0,0%,5.8%)', borderTop: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: 'hsl(0,0%,5.8%)', borderLeft: '1px dashed #3b3b3b', borderTop: '1px dashed #3b3b3b' }}></div>
                    ...
                    <div tw="flex relative h-[30px] w-full flex h-[60px]">
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b', borderRight: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b' }}></div>
                    ...
                    <div
                        ...
                        style={{ backgroundImage: 'linear-gradient(to top left ,#0a0a0a 30% , transparent 100%)' }}
                    >
                    </div>
                </div>
                <div tw="flex flex-col absolute right--4.5rem top-0 h-auto w-1/2">
                    ...
                    <div tw="flex relative h-[30px] w-full flex h-[60px]">
                        ...
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b' }}></div>
                        <div tw="w-66px h-66px" style={{ backgroundColor: '#0a0a0a', borderTop: '1px dashed #3b3b3b', borderLeft: '1px dashed #3b3b3b' }}></div>
                    </div>
                    <div
                        tw="absolute flex top-0 left-0 right-0 bottom--0 w-full"
                        style={{ backgroundImage: 'linear-gradient(to top right ,#0a0a0a 30% , transparent 100%)' }}
                    >
                    </div>
                </div>
            </div>
